...
class Class9TopicsSeeder extends Seeder
{
    ...
    protected function blueprintFor(string $subjectName): array
    {
        return match ($subjectName) {
            ...
            // PCTB Class 9 English (NCP 2023): 11 textbook units.
            'English' => $this->genericChapters('English', 'انگریزی', [
                'The Saviour of Mankind (New)',
                'Patriotism (New)',
                'Daffodils (New)',
                'Hazrat Asma (New)',
                'Women Empowerment through Entrepreneurship (New)',
                'The Value of Time (New)',
                'If (New)',
                'The Impact of Globalisation on Culture and Economy (New)',
                'Quality Education: A Key to Success (New)',
                'The Silent Predator and the Majestic Prey – Snow Leopard and Markhor (New)',
                'The Dear Departed (New)',
            ], 'انگریزی'),
