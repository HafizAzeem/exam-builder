                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink :href="route('builder')" :active="route().current('builder')">Paper Builder</NavLink>
                                <NavLink :href="route('past-papers.index')" :active="route().current('past-papers.*')">Past Papers</NavLink>
                                <NavLink
